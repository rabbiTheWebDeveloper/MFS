...
import {
  ...
  useCashInAminListQuery,
  useCashinApproveMutation,

} from "../../redux/api/adminApi";

const AdminCashIn = () => {
  const { data } = useCashInAminListQuery();
  const [cashinApprove] = useCashinApproveMutation();
  ...
  const handleChange = async (event, id) => {
    try {
      ...
      const response = await cashinApprove({ id, body: data }).unwrap();
